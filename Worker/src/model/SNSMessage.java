...
public class SNSMessage {
	...
	private String message;// TweetID+ sentiment
	...
	public String getSigningCertURL() { // Json String -> .SigningCertURL instead of signCertURL
		return signingCertURL;
		// when ObjectMap transfer ob -> JSON, ob.getProperty(), get ob's all properties, find out SigningCertURL property, use the getSignCertURL() here
	}
